      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="font-serif text-xl text-white/90 max-w-2xl mx-auto">
            Reach out for spiritual guidance, healing sessions, or any questions about your spiritual journey
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-serif text-white/80 text-lg font-semibold">Anita Madan</p>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="font-serif text-white/70 text-sm">
                    Our AI-enhanced readings provide insights based on tarot symbolism and patterns. 
                    While we strive for accuracy, remember that you have free will to shape your destiny.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-serif text-white/70 text-sm">
                    Most readings take 30-45 minutes, depending on the complexity of your questions 
                    and the depth of guidance you seek.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-serif text-white/70 text-sm">
                    ...
                    Contact us for updates on availability in your region.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-serif text-white/70 text-sm">
                    Yes, you can reschedule up to 24 hours before your appointment. 
                    Contact us via email or phone to make changes.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="font-serif text-white/70 mb-4">
                  Stay connected with daily insights, crystal wisdom, and spiritual guidance.
                </p>
